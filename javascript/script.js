...
function updateTimer() {
  const targetDate = new Date("august 29, 2026 20:45:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543546501647'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543858499833'; // Número para el primer botón
  const recipientNumber2 = '543853142747'; // Número para el segundo botón
